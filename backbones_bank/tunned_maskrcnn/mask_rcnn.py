...
# model = maskrcnn_resnet50_fpn(pretrained=False, num_classes=6, min_size=460, max_size=1333)

# images = torch.rand((2, 3, 460, 599))
# images = list(image for image in images)

# model.eval()

# predictions, feat = model(images)

# print(feat['0'].shape, predictions)